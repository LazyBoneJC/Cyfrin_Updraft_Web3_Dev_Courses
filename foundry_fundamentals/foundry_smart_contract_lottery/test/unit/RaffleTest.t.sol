...
contract RaffleTest is Test, CodeConstants {
    ...
    function testDontAllowUserToEnterWhileRaffleIsCalculating() public {
        // Arrange
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
    ...
    function testCheckUpkeepReturnsFalseIfEnoughTimeHasntPassed() public {
        ...
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
        // vm.warp(block.timestamp + interval - 1); // less than interval
        // vm.roll(block.number + 1);
    ...
    function testCheckUpkeepReturnsTrueWhenParametersAreGood() public {
        ...
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
        vm.warp(block.timestamp + interval + 1); // more than interval
        vm.roll(block.number + 1);
    ...
    // We can use vm.recordLogs() to record the logs and then retrieve them with vm.getRecordedLogs()
        ...
        raffleEntered
    {
        ...
        assert(uint256(raffleState) == 1); // 1 means CALCULATING state
    }
        ...
        skipFork
    {
        ...
        assert(uint256(raffleState) == 0); // 0 means OPEN state
